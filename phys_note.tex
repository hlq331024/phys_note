...
\begin{align*}
\partial_0A^{\mu}&=\frac{\partial\mathcal{H}}{\partial\Pi_{\mu}}+\lambda\frac{\partial\phi}{\partial\Pi_{\mu}}\\
{-}\partial_0\Pi_{\mu}&=\frac{\partial\mathcal{H}}{\partial A^{\mu}}+\lambda\frac{\partial\phi}{\partial A^{\mu}}
\end{align*}
where the constraint $\phi\equiv\Pi_0$. To be more specific,
\begin{align*}
\partial_0A^0&=\lambda\\
\partial_0A^i&=\Pi_i-\partial_iA^0\\
{-}\partial_0\Pi_0&=\partial_i\Pi_i-m^2A^0\\
{-}\partial_0\Pi_i&=-\nabla^2A^i+\partial_i\partial_jA^j+m^2A^i
\end{align*}
...
\]
and the consistency condition $\partial_0\partial_0\Pi_0=0$ requires that
\[
...
\]
and thus by definition, the two constraints are second class.
...
and the consistency condition $\partial_0\partial_0\Pi_0=0$ requires that
\[
0=\partial_i\partial_0\Pi_i=\nabla^2\partial_iA^i-\nabla^2\partial_jA^j=0\qquad
\text{automatically satisfied}
\]
Therefore, no constraints other than the above two are needed. Notice that
\begin{align*}
...
\end{align*}
and thus by definition, the two constraints are first class.
